        ...
        public static void Initialize(StudentTrackerContext context)
        {
            ...
            if (!context.Faculties.Any())
            {
                ...
                var faculties = new Faculty[]
                {
                    new Faculty
                    {
                        FacultyName = "Факультет Менеджмента и предпринимательства", FacultyShortName = "МиП",
                        ImageName = "mip.png"
                    },
                    new Faculty
                    {
                        FacultyName = "Факультет Компьютерных технологий и информационной безопасности",
                        FacultyShortName = "КТиИБ", ImageName = "ktib.png"
                    },
                    new Faculty
                    {
                        FacultyName = "Факультет Торгового дела", FacultyShortName = "ТД", ImageName = "td.png"
                    },
                    new Faculty
                    {
                        FacultyName = "Учетно-экономический факультет", FacultyShortName = "УЭФ", ImageName = "uef.png"
                    },
                    new Faculty
                    {
                        FacultyName = "Факультет Экономики и финансов", FacultyShortName = "ЭиФ", ImageName = "eif.png"
                    },
                    new Faculty {FacultyName = "Юридический факультет", FacultyShortName = "ЮФ", ImageName = "urf.png"},
                    new Faculty
                    {
                        FacultyName = "Факультет Лингвистики и журналистики", FacultyShortName = "ЛиЖ",
                        ImageName = "lig.png"
                    }
                };
